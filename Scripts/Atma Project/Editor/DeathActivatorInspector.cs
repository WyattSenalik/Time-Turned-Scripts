...
{
    /// <summary>
    /// Modifies the default inspector for the <see cref="DeathActivatorImplementation"/> script.
    /// </summary>
    [CustomEditor(typeof(DeathActivatorImplementation))]
    public class DeathActivatorInspector : Editor
    {
